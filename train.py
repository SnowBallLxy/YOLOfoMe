...
train_dataset = yoloDataset(root=file_root,list_file='train.txt',train=True,transform = [transforms.ToTensor()] )
...
test_dataset = yoloDataset(root=file_root,list_file='test.txt',train=False,transform = [transforms.ToTensor()] )
